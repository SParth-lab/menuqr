    ...
    <div>
        ...
        {data.map((d) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute bottom-0 w-full rounded-t bg-[var(--claret)]" style={{ height: Math.max(scans, d.qrScans > 0 ? 2 : 0) }} />
            </div>
          );
        })}
      </div>
      <div className="mt-2 flex items-center justify-between text-[10px] text-[var(--muted)]">
        ...
        <span className="flex items-center gap-3">
          ...
          <span className="flex items-center gap-1"><span className="inline-block h-2 w-2 rounded-sm bg-[var(--claret)]" /> QR scans</span>
        </span>
